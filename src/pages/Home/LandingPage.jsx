      ...
      >
        <div className="carousel-inner">
          <div className="carousel-item active">
            <img
              src="https://cdn.educba.com/academy/wp-content/uploads/2024/01/Tourist-Places-in-Kenya.jpg"
          ...
          <div className="carousel-item">
            <img
              src="https://i.natgeofe.com/k/f91c4f59-8484-488b-b95d-dda6bea8b294/kenya-tribal-people_4x3.jpg"
              className="d-block w-100"
              alt="Second slide"
            />
          </div>
          ...
          <div className="carousel-item">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRQ0EcPvWCiI6gGnDVCMtV2YJvDI-yEs7xX4Q&s"
              className="d-block w-100"
              alt="Third slide"
            />
          </div>
